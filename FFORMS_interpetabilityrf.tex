...
Global interpretations help us to understand the entire modeled
...
Eventhough case 1 and case 3 share similar characteristics, low values
of autocorrelation coefficients in differenced series corresponds to
case 3 From \autoref{fig:quarterlylime2} we can see how the different
variation in strength of seasonality influence the FFORMS framework to
select different types of forecast-models. For example, SARIMA models
was selected when the seasonality vary between 0.579 and 0.787 (case 1),
ETS-seasonal models is selected when the strength of seasonality is
...
trend and seasonal component is selected (case 3). According to
