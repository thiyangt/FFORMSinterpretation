...
\textbf{Mean decrease in Gini coefficient}
...
\textbf{Permutation-based variable importance measure}
...
\textbf{Variable importance measure based on PDP}
...
\textbf{Individual conditional expectation (ICE) curves}
...
\textbf{Variable importance measure based on ICE curves}
...
\subsection{Visualise algorithm performance in the
feature-space}\label{visualise-algorithm-performance-in-the-feature-space}
