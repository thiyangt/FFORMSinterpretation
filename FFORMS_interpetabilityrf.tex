...
\begin{figure}[h]
\includegraphics[width=1.15\linewidth]{figures/framework} \caption{FFORMS (Feature-based FORecast-Model Selection) framework. The offline phase is shown in blue and the online phase by red.}\label{fig:framework}
\end{figure}
...
\subsection{Train a random forest
