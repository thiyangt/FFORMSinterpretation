...
The poportion of times each time series was classified to each class for yearly series are shown in \autoref{fig::hourly_oob}. Except neural network class, the distribution corresponds to the correct classification dominated the top. In neural network category, distribution corresponds to snaive class slightly dominateds the distribution corresonds to neural network category. Overall, for hourly series random walk with drift models, tbats and neural network models have high chance of being selected. Furthurmore, all distributions corresponds to the neural network category located furthur away from zero corresponds to the x-axis indicating, every time series selects neural network models at least once from the trees of the random forest. 
