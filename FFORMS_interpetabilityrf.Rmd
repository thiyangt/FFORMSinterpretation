...
\autoref{fig::oob_weekly} poportion of times each time series was classified to each class. ARMA/AR/MA class shows some unusual behaviour within some categories. This is due to class imbalance ratio, ARMA/AR/MA class contains fewer number of observations (11) within the training set. 
