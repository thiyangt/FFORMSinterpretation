...
We now explain application of the extended FFORMS framework to the M4-competition data. 

```{r framework, fig.cap="FFORMS (Feature-based FORecast-Model Selection) framework. The offline phase is shown in blue and the online phase by red.", out.width='115%'}
