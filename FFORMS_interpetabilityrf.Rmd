...
library(knitr)
knitr::opts_chunk$set(echo = FALSE, cache=FALSE, messages=FALSE, warning=FALSE, fig.path = 'figures/', dev=c('png'), fig.pos= "h", external = TRUE)
...
```{r oobquarterlymonthly1, fig.height=15, fig.width=15, fig.cap="Distribution of proportion of times each time series was assigned to each class based on OOB sample.  Each row represent the predicted class label and colours of boxplots corresponds to class label of \"best\" forecasting method. X-axis denotes the proportion of times the time series was predicted into each class. Results for quarterly and monthly series are shown in Figures A and B respectively.", fig.pos="h"}
```

\clearpage

```{r oobquarterlymonthly2, fig.height=38, fig.width=30, fig.cap=" Distribution of proportion of times each time series was assigned to each class based on OOB sample.  Each row represent the predicted class label and colours of boxplots corresponds to class label of \"best\" forecasting method. X-axis denotes the proportion of times the time series was predicted into each class. Results for quarterly and monthly series are shown in Figures A and B respectively.(Continue from Figure 5)", fig.pos="h"}
```
...
```{r yearlylime2, fig.height=10, fig.width=15, fig.cap="Local interpretable Model-agnostic explanations for six selected yearly time series. Features denoted with green colour are supporting features for an outcome label and length of the bar is proportional to the weight of a feature.", fig.pos="h", fig.align="center", dev='pdf', cache=FALSE, dev='pdf'}
```
...
```{r quarterlylime2, fig.height=10, fig.width=15, fig.cap="Local interpretable Model-agnostic explanations for four selected quaterly time series. Features denoted with green colour are supporting features for an outcome label and length of the bar is proportional to the weight of a feature.", fig.pos="h", fig.align="center", cache=FALSE, dev='pdf'}
```
...
```{r hourlylime2, fig.height=10, fig.width=15, fig.cap="Local interpretable Model-agnostic explanations for four selected hourly time series. Features denoted with green colour are supporting features for an outcome label and length of the bar is proportional to the weight of a feature.", fig.pos="h", fig.align="center", dev='pdf'}
```
