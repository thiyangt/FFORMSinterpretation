...
The first ACF value of the original series appears to be important with in rwd and ARMA class. The reason could be, the first ACF value can easily separate very clear stationary and nonstationary models.  The features related to different types of trend (linear trend: measured by `linearity`, damped trend: measured by `beta`, exponential trend: measured by curvature) are assigned a very high importance with in ETS_T, ETS_DT and ETS_NTNS. The features related to randomness of the series such as `spikiness` and `lmres_acf` are also assigned a high importance. The length of time series (N) is assigned a very low importance within random walk class. 
