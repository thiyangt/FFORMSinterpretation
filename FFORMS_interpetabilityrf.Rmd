...
For quarterly and monthly data same set of features and class-labels are used to training the model. Hence, this consistency between the results of quarterly and monthly series would provide evidence in support of the validity and trustability of the model.  Seasonality, trend, spikiness and linearity appear to be most important features across all categories. One notable difference between quarterly series and monthly series is, features calculated based on parameter estimates of ETS(A,A,A), ACF and PACF-based features related to seasonal lags and seasonally differenced series were assigned higher importance than the quarterly series FFORMS framework.  
