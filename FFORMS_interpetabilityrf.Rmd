...
```{r friedmany, fig.height=30, fig.width=20, fig.cap="Heat maps of relative strength of all possible pairwise interactions calclated based on Friedman's H-statistic", fig.pos="h", message=FALSE, warning=FALSE, cache=FALSE}
```
...
```{r friedmanQ, fig.height=30, fig.width=20, fig.cap="Heat maps of relative strength of all possible pairwise interactions calclated based on Friedman's H-statistic for quarterly data.", fig.pos="h", message=FALSE, warning=FALSE, cache=FALSE}
```

\newpage

```{r friedmanQ2, fig.height=15, fig.width=20, fig.cap="Heat maps of relative strength of all possible pairwise interactions calclated based on Friedman's H-statistic for quarterly data(cont).", fig.pos="h", message=FALSE, warning=FALSE, cache=FALSE}
```
...
```{r oobmonthly, fig.height=28, fig.width=20, fig.cap="Distribution of proportion of times each monthly time series was assigned to each class in the forest.  Each row represent the predicted class label and colour of boxplots corresponds to true class label. X-axis denotes the proportion of times a time series is classified in each class.", fig.pos="h"}
```
...
```{r yearlypca, fig.height=10, fig.width=20, fig.cap="Distribution of prediction space across instance space for yearly time series. PC1 and PC2 are the first two principal components.", fig.pos="h", fig.align="center"}
```

\clearpage

```{r quarterlypca, fig.height=15, fig.width=20, fig.cap="Distribution of prediction space across instance space for quarterly time series. PC1 and PC2 are the first two principal components.", fig.pos="h"}
```

\newpage

```{r monthlypca, fig.height=15, fig.width=20, fig.cap="Distribution of prediction space across instance space for monthly time series. PC1 and PC2 are the first two principal components.", fig.pos="h"}
```

\clearpage

```{r pcaweekly, fig.height=15, fig.width=20, fig.cap="Distribution of prediction space across instance space for weekly time series. PC1 and PC2 are the first two principal components.", fig.pos="h", fig.align="center"}
```

\clearpage

```{r pcadaily, fig.height=5, fig.width=10, fig.cap="Distribution of prediction space across instance space for daily time series. PC1 and PC2 are the first two principal components.", fig.pos="h", fig.align="center"}
```


```{r pcahourly, fig.height=5, fig.width=10, fig.cap="Distribution of prediction space across instance space for hourly time series. PC1 and PC2 are the first two principal components.", fig.pos="h", fig.align="center"}
```
