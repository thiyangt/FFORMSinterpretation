...
# Evaluation based on M4 competition data
...
```{r friedmany, fig.height=14, fig.width=19, fig.cap="", fig.pos="h", dev='pdf'}
```
...
```{r friedmanq, fig.height=10, fig.width=18, fig.cap=""}
...
```{r friedmanm, fig.height=15, fig.width=18, fig.cap=""}
...
```{r friedmanw, fig.height=15, fig.width=20, fig.cap="", fig.pos="h", fig.align="center"}
```
...
```{r friedmanh, fig.height=15, fig.width=20, fig.cap="", fig.pos="h", fig.align="center"}
```
...
```{r friedmand, fig.height=15, fig.width=20, fig.cap="", fig.pos="h", fig.align="center"}
```
