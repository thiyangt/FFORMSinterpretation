...
int1 <- ggplot(
  ...
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("snaive [0-1]")+  theme(aspect.ratio=1, text = element_text(size=20))
...
int2 <- ggplot(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("rw [0-1]")+  theme(aspect.ratio=1, text = element_text(size=20))
## rwd
int3 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("rwd [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))
## mstlarima
int4 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("mstlarima [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))
## mstlets
int5 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("mstlets [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))
## tbats
int6 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("tbats [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))
## stlar
int7 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("stlar [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))
## theta
int8 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("theta [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))
## nn
int9 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("nn [0-1]")+ theme(aspect.ratio=1, text = element_text(size=20))
## wn
int10 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 1), breaks = seq(0, 1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ggtitle("wn [0-1]")+theme(aspect.ratio=1, text = element_text(size=20))+theme(legend.title=element_blank())
...
int1 <- ggplot(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("snaive [0-0.3]")+  theme(aspect.ratio=1, text = element_text(size=20))
...
int2 <- ggplot(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("rw [0-0.3]")+  theme(aspect.ratio=1, text = element_text(size=20))
## rwd
int3 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("rwd [0-0.3]")+theme(aspect.ratio=1, text = element_text(size=20))
## mstlarima
int4 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("mstlarima [0-0.3]")+theme(aspect.ratio=1, text = element_text(size=20))
## mstlets
int5 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0,0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("mstlets [0-0.3]")+theme(aspect.ratio=1, text = element_text(size=20))
## tbats
int6 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("tbats [0-0.3]")+theme(aspect.ratio=1, text = element_text(size=20))
## stlar
int7 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("stlar [0-0.3]")+theme(aspect.ratio=1, text = element_text(size=20))
## theta
int8 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("theta [0-0.3]")+theme(aspect.ratio=1, text = element_text(size=20))
## nn
int9 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.3), breaks = seq(0, 0.3, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("nn [0-0.3]")+ theme(aspect.ratio=1, text = element_text(size=20))
## wn
int10 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.8), breaks = seq(0, 0.8, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ggtitle("wn [0-0.8]")+theme(aspect.ratio=1, text = element_text(size=20))+theme(legend.title=element_blank())
...
int1 <- ggplot(
  ...
  scale_fill_viridis_c(limits = c(0, 0.1), breaks = seq(0, 0.1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("snaive [0-0.1]")+ theme(aspect.ratio=1, text = element_text(size=20))
...
int2 <- ggplot(
  ...
  scale_fill_viridis_c(limits = c(0, 0.2), breaks = seq(0, 0.2, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("rw [0-0.2]")+ theme(aspect.ratio=1, text = element_text(size=20))
## rwd
int3 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
...
int4 <- ggplot(
  ...
  scale_fill_viridis_c(limits = c(0, 0.1), breaks = seq(0, 0.1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("mstlarima [0-0.1]")+ theme(aspect.ratio=1, text = element_text(size=20))
## mstlets
int5 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.1), breaks = seq(0, 0.1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("mstlets [0-0.1]")+ theme(aspect.ratio=1, text = element_text(size=20))
## tbats
int6 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.2), breaks = seq(0, 0.2, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("tbats [0-0.2]")+ theme(aspect.ratio=1, text = element_text(size=20))
## stlar
int7 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.2), breaks = seq(0, 0.2, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("stlar [0-0.2]")+ theme(aspect.ratio=1, text = element_text(size=20))
## theta
int8 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.1), breaks = seq(0, 0.1, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("theta [0-0.1]")+ theme(aspect.ratio=1, text = element_text(size=20))
## nn
int9 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.2), breaks = seq(0, 0.2, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ theme(legend.position="none")+ggtitle("nn [0-0.2]")+ theme(aspect.ratio=1, text = element_text(size=20))
## wn
int10 <- ggplot(
  data = linearity.sediff_seacf1.h,
  aes_string(
  ...
  scale_fill_viridis_c(limits = c(0, 0.8), breaks = seq(0, 0.8, 100), option = "A", direction = -1) +
  xlab("linearity") + ylab("sediff_seacf1")+ggtitle("wn [0-0.8]")+theme(legend.title=element_blank())+ theme(aspect.ratio=1, text = element_text(size=20))
