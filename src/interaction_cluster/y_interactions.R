...
lumpiness.stability.y <- twowayinteraction(rfu_m4yearly, lumpiness, stability,
                                  fulldf = yearly_training,
                                  subsetdf = subset_yearly, grid.resolution=20, trim1=TRUE)
save(lumpiness.stability.y, file="phdproject2/lumpiness.stability.y.rda")
