...
diff1y_pacf5.lumpiness.q <- twowayinteraction(rfu_m4quarterly, diff1y_pacf5, lumpiness, 
                                  fulldf = quarterly_training,
                                  subsetdf = subset_quarterly, grid.resolution=20)
save(diff1y_pacf5.lumpiness.q, file="phdproject2/diff1y_pacf5.lumpiness.q.rda")
# 
